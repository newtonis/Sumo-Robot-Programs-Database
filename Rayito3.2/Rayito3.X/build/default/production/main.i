...
const int speed_vals[2] = {500 , 600};
...
if (time[0] > 200 && faux == 0){

faux = 1;
}
if (faux == 1 && time[0] > 400){
...
if (time[0] < 1000) setA();
if (time[0] > 1000 && time[0] < 2000) setB();
if (time[0] > 2000 && time[0] < 3000) setC();
if (time[0] > 3000 && time[0] < 4000) setD();
...
int der = lp - old_lp;
double dif = (double)lp * kp_val[mode] + (double)der * kd_val[mode];
if (lp > -60 && lp < 60){
PORTBbits.RB4 = 0;
PORTCbits.RC1 = 0;
PORTDbits.RD2 = 1;
